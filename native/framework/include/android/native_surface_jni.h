...
#include <android/native_surface.h>
...
/**
 * Return the ANativeSurface associated with a Java Surface object,
 * for interacting with it through native code.  This acquires a reference
 * on the ANativeSurface that is returned; be sure to use ANativeSurface_release()
